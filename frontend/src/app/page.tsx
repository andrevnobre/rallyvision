      ...
      <header className="bv-auth-header">
        <div className="bv-container bv-auth-header-inner">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <Link href="/profile" className="bv-btn bv-btn-ghost bv-btn-sm bv-hide-mobile">Perfil</Link>
            {(userPlan === "pro" || userPlan === "club") && (
              <Link href="/coach" className="bv-btn bv-btn-ghost bv-btn-sm bv-hide-mobile">Coach</Link>
            )}
